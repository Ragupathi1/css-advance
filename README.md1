### HTML AND CSS  ADVANCE PAGE TO RE-CREATE THE IMAGE

### AIM:
To re-create a HTML and CSS advance page based on the given image.
...
![image](https://github.com/Ragupathi1/css-advance/assets/143526042/b85681e8-f4f0-453a-aa5f-cd37d1d0a3a8)
